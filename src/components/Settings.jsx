...
const themes = [
  { key: 'coffee',      label: 'coffee',        img: '/coffee.png' },
  { key: 'matcha',      label: 'matcha',        img: '/matcha.png' },
  { key: 'choco-berry', label: 'choco berry',   img: '/choco-berry.png' },
  { key: 'blue-lemon',  label: 'blue lemonade', img: '/blue-lemon.png' },
...
export default function Settings({
  ...
  const { playClick, playToggle, playSuccess } = useSounds()
  ...
  return (
    <>
      <style>{`
        ...
        .s-theme-item.active .s-theme-img-wrap { border-color: var(--accent); }
        .s-theme-item:hover .s-theme-img-wrap  { transform: translateY(-2px); }
      ...
      <div className="s-overlay" onClick={e => { if (e.target === e.currentTarget) handleClose() }}>
        <div className="s-panel" role="dialog" aria-modal="true" aria-label="Settings">
          ...
          <button className="s-close" onClick={handleClose} aria-label="Close settings">x</button>
          ...
          <div className="s-themes">
            {themes.map(theme => (
              <button
                ...
                onClick={() => { playToggle(); setSelectedTheme(theme.key) }}
